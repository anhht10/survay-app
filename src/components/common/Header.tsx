        ...
        <div className="space-y-3">
          {hasApkDownload && (
            <a
              ...
              className="block rounded-2xl border border-slate-200 p-4 transition-colors hover:bg-slate-50 active:scale-[0.99]"
            >
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm text-slate-500 leading-snug">File cài đặt Android để cài trực tiếp lên máy</p>
                </div>
              </div>
            </a>
          )}
          ...
          {canInstall && (
            <button
              ...
              className="w-full block rounded-2xl border border-blue-200 bg-blue-50 p-4 text-left transition-colors hover:bg-blue-100 active:scale-[0.99]"
            >
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm text-blue-700 leading-snug">Cài app web vào màn hình chính của thiết bị</p>
                </div>
              </div>
            </button>
          )}
